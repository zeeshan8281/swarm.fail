...
type Entry = { kind: "reference" | "submission"; handle: string; model: string; tag: string; note: string; n: number; meanSteps: number; score: number; landedAt?: string | null; author?: string | null; login?: string | null };
...
export async function GET() {
  ...
  return NextResponse.json(cache.board);
}
