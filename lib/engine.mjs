...
// 1500 is ~10x the worst policy that still passes, so it changes no OK score —
// it just stops us paying 12s of CPU to watch a hopeless policy flail, which is
// what the mazes turned Bounce Sweep and crowd-scout into.
